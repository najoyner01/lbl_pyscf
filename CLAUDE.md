...
| ~~**Screening**~~ | `gto/ecp.py` | DONE on branch `ecp-screening` (validated on A100, screened==unscreened to 1e-10). 3-center overlap estimate mirroring `check_3c_overlap` in pyscf; toggle `ecp.SCREEN_ECP`. Pending: benchmark + merge. |
